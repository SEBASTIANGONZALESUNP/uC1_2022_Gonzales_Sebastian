;Parcial-2_Secuencia_leds
;________________________________________________________________________________
;________________________________________________________________________________
; @file: P1-Corrimiento_Leds.s
; @brief:
;   Este es un programa para que al presionar el botón de placa se ejecute un
;   patrón de encendidos de leds previamente establecido en los pines del puerto
;   C de la placa.
;
;   La secuencia se detiene al presionar otro pulsador externo conectado en el
;    pin RB4 o hasta que el número de repeticiones sea 5.
;   Otro pulsador externo conectado al RF2 reinicia toda la secuencia y apaga los
;   leds.
;   Mientras no se active ninguna interrupción, el programa principal, realice un
;   toggle del led de la placa cada 500 ms.
; @date: 29/01/2023
